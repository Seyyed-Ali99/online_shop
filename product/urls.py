...
from .views import AddCategory, AddProduct, AddComment, ProductUpdate, ProductList, ProductDetail, ProductDelete,CommentList,AddRate
...
urlpatterns = [
    ...
    path("product/<int:id>/add_rate/",AddRate.as_view(),name="add_rate"),
]